...
vm_size                 = "Standard_B2ps_v2"    # VM size for AKS nodes
kubernetes_version      = "1.34.6"             # Kubernetes version for AKS cluster

# GitOps Configuration
gitops_repo_url  = "https://github.com/Ahad0p/azure-devops-gitOps.git" # GitOps repository for infrastructure configs (reference only)
argocd_namespace = "argocd"                                          # Namespace where ArgoCD will be deployed

# Application Deployment Configuration 
app_repo_url  = "https://github.com/Ahad0p/azure-devops-gitOps.git" # Repository containing your application manifests
